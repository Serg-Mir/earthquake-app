...
def main():
    ...
    parser.add_argument(
        "--start_time", help="Format: YYYY-MM-DD", type=str, required=False, default="2023-01-01"
    )
    parser.add_argument(
        "--end_time", help="Format: YYYY-MM-DD", type=str, required=False, default="2023-12-31"
    )
    parser.add_argument("--radius", help="Max radius in KM", type=int, required=False, default=500)
